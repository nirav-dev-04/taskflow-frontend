                ...
                <div className="space-y-3">
                  ...
                  {comments.map((c) => (
                    <div key={c.id} className="flex gap-2.5">
                      <div
                        className={`w-7 h-7 rounded-full flex-shrink-0 flex items-center justify-center text-[10px] font-bold text-white ${getAvatarColor(c.author)}`}
                      >
                  ...
                  <div className="flex gap-2.5 pt-1">
                    <div className="w-7 h-7 rounded-full flex-shrink-0 bg-blue-500 flex items-center justify-center text-[10px] font-bold text-white">
                      YO
                    </div>
                    <div className="flex-1 flex gap-2">
                      ...
                      <button
                        ...
                        className="px-3 py-2 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium transition-all active:scale-95 flex-shrink-0"
                      >
                        Post
                      </button>
                    </div>

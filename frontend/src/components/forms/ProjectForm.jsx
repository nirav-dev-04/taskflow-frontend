  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div>
        ...
        <div
          className="flex flex-wrap items-center gap-1.5 p-2.5 rounded-xl min-h-11"
        ...
        >
          ...
          <input
            ...
            className="flex-1 min-w-25 text-xs outline-none bg-transparent"
          ...
          <div className="flex flex-wrap gap-2">
            {teamMembers.map((member) => {
              ...
              return (
                ...
                >
                  <div
                    className="w-5 h-5 rounded-lg flex items-center justify-center text-[9px] font-black text-white shrink-0"

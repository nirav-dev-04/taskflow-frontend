      ...
      <div className="relative w-full max-w-lg bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="px-6 py-5 space-y-4 max-h-[70vh] overflow-y-auto">
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-1.5 p-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 min-h-10.5">
              {form.tags.map((tag) => (
                <span
                  key={tag}
              ...
              <input
                ...
                className="flex-1 min-w-25 text-xs text-slate-700 dark:text-slate-200 bg-transparent outline-none placeholder-slate-400 dark:placeholder-slate-500"
              />
            </div>
          </div>
        </div>

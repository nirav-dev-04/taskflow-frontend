...
const MyTasks = () => {
  ...
  const toggleDone = async (task) => {
    // Toggle between "done" and "todo" — "completed" no longer valid
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-wrap items-start justify-between gap-2">
                      ...
                      <div className="flex gap-2">
                        <span className="text-xs px-2 py-0.5 rounded-lg font-medium" style={{ backgroundColor: priority.bg, color: priority.color, fontFamily: "DM Sans, sans-serif" }}>
                          {priority.label}
                        </span>
                        <span className="text-xs px-2 py-0.5 rounded-lg font-medium" style={{ backgroundColor: status.bg, color: status.color, fontFamily: "DM Sans, sans-serif" }}>
                          {status.label}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 mt-2">
                      {task.project?.name && (
                        <span className="text-xs px-2 py-0.5 rounded-lg" style={{ backgroundColor: "rgba(167,139,250,0.1)", color: "#a78bfa", fontFamily: "DM Sans, sans-serif" }}>
                          {task.project.name}
                        </span>
                      )}
                      {task.dueDate && (

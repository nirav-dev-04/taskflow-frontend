        ...
        >
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div key={key}>
                ...
                <div className="relative">
                  <Icon
                    ...
                    size={17}
                    style={{ color: focusedField === key ? "#6c63ff" : muted }}
                  />
                  <input
                    type={type}
                    value={form[key]}
                    ...
                    style={{
                      ...
                      border: `1px solid ${focusedField === key ? "#6c63ff" : border}`,
                      color: text,
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-xl font-semibold transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] mt-2"
              style={{
                background: loading
                  ? "#3a3a5c"
